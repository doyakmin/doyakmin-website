export const antiCheatNotice20251006 = {
    ...
    content: `
        ...
        <p class="text-gray-700 mb-6">
            최근 일부 계정에서 <strong>비정상적인 방법(GPS 스푸핑 등)</strong>을 통해 건물 점령을 시도한 사례가 확인되었습니다.
        ...
        <p class="text-gray-700 mb-6">
            모든 이용자분들이 공정하게 즐길 수 있는 환경을 위해 <strong>비정상적인 플레이는 삼가</strong>해 주시기 바랍니다.
        </p>

        <p class="text-gray-700">감사합니다.<br/>한국지 운영팀 드림</p>
    `
};
